fn main() {
    ...
    let credit_card_icici_password = std::env::var("CREDIT_CARD_ICICI_PASSWORD").expect("Please provide password to use for opening ICICI Bank Credit Card statements using environment variable \"CREDIT_CARD_ICICI_PASSWORD\"");
    println!(
